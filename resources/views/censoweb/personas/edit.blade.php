...
<div class="x_panel">
	<div class="x_title">
		<div class="pull-left"><h3><strong>Ficha Familiar: </strong></h3></div>
	...
	<div class="x_content">
		{!! Form::model($personas,['method'=>'PATCH', 'route'=>['persona-censoweb-update', $personas]]) !!}
			...
			<div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">
				<div class="col-md-12 col-sm-12 col-xs-12 form-group">
					...
					<div class="col-md-3 col-md-3 col-xs-12 col-sm-6 col-md-8 form-group" >
						...
						{!! Form::text('nombre_1',null, array('class'=>'form-control','required')) !!}
					</div>
					{{-- segundo nombre --}}
					<div class="col-md-3 col-md-3 col-xs-12 col-sm-6 col-md-8 form-group" >
